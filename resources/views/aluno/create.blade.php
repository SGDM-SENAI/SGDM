...
<div class="card card-primary card-outline direct-chat direct-chat-primary shadow-none">
    <div class="card-header">        
        <div class="d-flex justify-content-between w-100">
            <h3 class="card-title">
                <span>@lang('Formulário de cadastro de aluno')</span>
            </h3>       
    ...
    <form action="{{ route('aluno.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="form-group">
                <x-adminlte-input name="nome_aluno" label="Nome da aluno" placeholder="Informe o nome da aluno a ser cadastrado." fgroup-class="col-md" required="required" enable-feedback/>          
            </div>
            <div class="form-group">
                <x-adminlte-input name="telefone" label="Telefone" placeholder="Informe o nome da aluno a ser cadastrado." fgroup-class="col-md" required="required" enable-feedback/>          
            </div>
            <div class="form-group">                   
