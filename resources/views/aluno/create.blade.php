    ...
    <div class="card card-admin card-outline direct-chat direct-chat-primary shadow-none">
        ...
        <div class="card-body hidden-ativo" id="form-1">
            ...
            <div class="card-column col-7">
                ...
                <div class="form-group col-11">
                    <x-adminlte-input type="number" name="cpf" label="Cpf:" placeholder="Informe o cpf do aluno a ser cadastrado." required="required" enable-feedback />
                </div>
                <div class="form-group col-11">
        ...
        <div class="card-body" id="form-2">
            ...
            <div class="card-column col-7">
                ...
                <div class="form-group col-11">
                    <x-adminlte-input name="nome_pai" label="Nome do pai aluno:" placeholder="Informe o nome do pai do aluno a ser cadastrado." required="required" enable-feedback />
                </div>
                <div class="form-group col-11">
